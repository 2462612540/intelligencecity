...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'errorLoadConfig': 'Server properties not loaded, upload can not work.',
    },
    'simpleupload':{
        'exceedSizeError': 'File Size Exceed',
        'exceedTypeError': 'File Type Not Allow',
    ...
    'loadconfigError': 'Get server properties error.',
    'loadconfigFormatError': 'Server properties format error.',
    'loadconfigHttpError': 'Get server properties http error.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the properties!",
